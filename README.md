...
주의: **나에게 보내기는 채팅방에 메시지만 남기며, 일반 수신 메시지처럼 푸시 알림을 발생시키지 않습니다.**
예매 오픈을 즉시 알아차릴 수 있는 알림이 필요하면 별도의 푸시 지원 전송 수단이 필요합니다.
이는 [카카오가 안내한 메모 기능의 제한](https://devtalk.kakao.com/t/rest-api/142306)이며,
현재 구현에는 별도의 푸시 전송 수단이 없습니다.
